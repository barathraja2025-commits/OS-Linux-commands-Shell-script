...
## OUTPUT
![Alt text](img/gvnewfile.png)


cat newfile | grep -i "hello"
## OUTPUT
![Alt text](img/cnewfilei.png)



cat newfile | grep -i -c "hello"
## OUTPUT
![Alt text](img/cnewfileic.png)



grep -R ubuntu /etc
## OUTPUT
![Alt text](img/grepR.png)


grep -w -n world newfile   
## OUTPUT
![Alt text](img/grepwn.png)
...
## OUTPUT
![Alt text](img/eg-w.png)


egrep -w '(H|h)ello' newfile 
## OUTPUT
![Alt text](img/egrep(H%7Ch).png)

egrep -w '(H|h)ell[a-z]' newfile 
## OUTPUT
![Alt text](img/egrep-w(a-z).png)
...
## OUTPUT
![Alt text](img/egerp(W%7Cw).png)


egrep '[1-9]' newfile 
## OUTPUT
![Alt text](img/egrep%5B1-9%5D.png)
...
egrep l{2} newfile
## OUTPUT
![Alt text](img/egrepl%7B2%7D.png)


egrep 's{1,2}' newfile
## OUTPUT 
![Alt text](img/egreps%7B1,2%7D.png)
...
sed -n -e '3p' file23
## OUTPUT
![Alt text](img/sed3p.png)


sed -n -e '$p' file23
## OUTPUT
![Alt text](img/sed$p.png)


sed  -e 's/Ram/Sita/' file23
## OUTPUT
![Alt text](img/sedRS.png)


sed  -e '2s/Ram/Sita/' file23
## OUTPUT
![Alt text](img/sed2RS.png)


sed  '/tom/s/5000/6000/' file23
## OUTPUT
![Alt text](img/sedt.png)


sed -n -e '1,5p' file23
## OUTPUT
![Alt text](img/sednp.png)


sed -n -e '2,/Joe/p' file23
## OUTPUT
![Alt text](img/sedne2.png)



sed -n -e '/tom/,/Joe/p' file23
## OUTPUT
![Alt text](img/sednee.png)


seq 10 
## OUTPUT
![Alt text](img/seq10.png)


seq 10 | sed -n '4,6p'
## OUTPUT
![Alt text](img/seq102p.png)


seq 10 | sed -n '2,~4p'
## OUTPUT

![Alt text](img/seq104p.png)

seq 3 | sed '2a hello'
## OUTPUT
![Alt text](<img/seq3 2a.png>)


seq 2 | sed '2i hello'
## OUTPUT
![Alt text](<img/seq2 2i.png>)

seq 10 | sed '2,9c hello'
## OUTPUT
![Alt text](<img/seq10 2,9.png>)

sed -n '2,4{s/^/$/;p}' file23
## OUTPUT
![Alt text](<img/sed n 2,4.png>)


sed -n '2,4{s/$/*/;p}' file23
## OUTPUT
![Alt text](<img/sedn 2,4.png>)
